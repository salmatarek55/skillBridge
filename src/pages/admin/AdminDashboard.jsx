...
export default function AdminDashboard() {
  ...
  const counts = data || { pendingProviders: 0, pendingServices: 0 };
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(99,102,241,0.10)] border border-indigo-100 p-6 sm:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-2xl shadow-sm flex-shrink-0">
              👤
            </div>
            <div>
