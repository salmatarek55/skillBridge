        ...
        <div className="w-full max-w-md z-5 bg-white rounded-xl p-10 shadow-[0px_12px_32px_rgba(28,27,34,0.08)]">
          ...
          >
            ...
            <button
              ...
              className="cursor-pointer w-full disabled:bg-slate-900 mt-4 bg-gradient-to-r from-purple-400 via-purple-300 to-purple-500 text-[#002117]/80 rounded-full py-3 font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-all disabled:opacity-60 duration-300"
            >
