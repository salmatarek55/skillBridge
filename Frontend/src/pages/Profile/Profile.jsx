      ...
      <div className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(99,102,241,0.10)] border border-indigo-100 p-6 sm:p-8">
        ...
        <div className="flex items-center gap-5 mb-8 pb-8 border-b border-indigo-50">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl font-bold text-purple-900 truncate">
              {user.name}
            </h1>
            ...
            <div className="flex justify-between">
              ...
              <span
                className={`inline-flex items-center -mt-1 text-[10px] font-bold px-3 py-1 rounded-full border ${roleConfig.bg} ${roleConfig.text} ${roleConfig.border}`}
              >
                {roleConfig.label}
              </span>
            </div>
        ...
        <div className="flex flex-col gap-3 mb-8">
          ...
          <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-xl">
            <HiOutlineIdentification className="text-xl text-purple-500" />
          ...
          <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-xl">
            <HiOutlineEnvelope className="text-xl text-purple-500" />
            <p className="text-sm font-semibold text-purple-400">
              {user.email}
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-xl">
            <HiOutlineShieldCheck className="text-xl text-purple-500" />
