      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 flex flex-col gap-4">
            ...
            <button className="bg-purple-100 text-purple-700 py-2 rounded-lg flex items-center justify-center gap-2 cursor-pointer hover:text-white hover:from-purple-400 hover:to-purple-500 hover:bg-gradient-to-r transition-all duration-300">
              <FiMessageCircle />
              Contact
            </button>
