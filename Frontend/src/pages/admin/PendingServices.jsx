...
export default function PendingServices() {
  ...
  const {
    ...
    onSuccess: (_, { approve }) => {
      toast.success(
        approve ? "Service approved successfully" : "Service rejected",
      );
        ...
        {isLoading ? (
          ...
          <div className="grid gap-4">
            {services.map((sv) => {
              ...
              const cat = sv.category ? getCategoryByName(sv.category) : null;
              return (
                <div
                  key={sv.id}
                  onClick={() => navigate(`/services/${sv.serviceId || sv.id}`)}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-3">
                        ...
                        <span className="text-xs text-indigo-500 font-medium flex items-center gap-1">
                          <HiOutlineBanknotes className="text-sm" />${sv.price}
                        </span>
